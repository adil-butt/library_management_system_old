					...
					if($result) {
						...
						?>
							...
							<tr>
								...
								<td>
								<?php 
									echo '<a href="edit-book.php?id='.$row["id"].'&id2='.$id.'"><button class="btn btn-outline-primary" >Edit</button></a>'; 
								?></td>
								<td>
								<?php 
									echo '<a href="delete-book.php?id='.$row["id"].'&id2='.$id.'"><button class="btn btn-outline-danger" >Delete</button></a>'; 
								?></td>
							</tr>
							</tbody>
						<?php
